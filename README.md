...
This repository contains the conceptual definition and theoretical framework for **Self-Repair**, 
...
├── LICENSE             # CC BY 4.0
├── paper/
│   └── self-repair.tex    # LaTeX dissertation
├── whitepaper/
│   └── self-repair.md     # White paper
└── translations/
    ├── de/             # German
    ├── en/             # English
    ├── tr/             # Turkish
...
```bibtex
@misc{vega2025selfrepair,
  author = {Vega, Adam Eren},
  title = {Self-Repair: A Conceptual Framework},
  year = {2025},
  publisher = {GitHub},
  url = {https://github.com/vegafoundation/self-repair}
}
```
